...
using PsiOffice.FinancialMovimentAPI.Config;
using PsiOffice.FinancialMovimentAPI.Model.Context;
using PsiOffice.FinancialMovimentAPI.Repository;
...
builder.Services.AddScoped<IFinancialMovimentRepository, FinancialMovimentRepository>();
